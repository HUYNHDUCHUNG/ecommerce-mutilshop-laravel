                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <img class="direct-chat-img" src="{{ asset('admin_asset/dist/img/user1-128x128.jpg')}}" alt="message user image" /><!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <img class="direct-chat-img" src="{{ asset('admin_asset/dist/img/user3-128x128.jpg')}}" alt="message user image" /><!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <ul class="products-list product-list-in-box">
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="{{ asset('admin_asset/dist/img/default-50x50.gif')}}" alt="Product Image"/>
                      </div>
                      <div class="product-info">
