...
<html>
  <head>
    ...
    <!-- Font Awesome Icons -->
    <link href="{{ asset('admin_asset///maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="{{ asset('admin_asset/dist/css/AdminLTE.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
    <link href="{{ asset('admin_asset/plugins/iCheck/square/blue.css')}}" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>Admin</b>MutilShop</a>
      </div><!-- /.login-logo -->
