    ...
    <div class="container-fluid">
                ...
                <div class="d-inline-flex align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('user.profile') }}"><button class="dropdown-item" type="button">Thông
                                        ...
                                        <a href="{{ route('user.order') }}"><button class="dropdown-item" type="button">Đơn Hàng</button></a>
                    ...
                    @else
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('user.login') }}"><button class="dropdown-item" type="button">Sign
                                        in</button></a>
                                <a href="{{ route('user.register') }}"><button class="dropdown-item" type="button">Sign up</button></a>
                            </div>
                        </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="{{ route('search-products') }}" method="GET" style="display: flex; align-items: stretch">
                        ...
                        <button type="submit" class="btn btn-xs border" >
                            <i class="fa fa-search" style="color: #FFD333"></i>
                        </button>
