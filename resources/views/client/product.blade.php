                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input filter active" id="price-all" data-filter_min = "0" data-filter_max = "0">
                            <label class="custom-control-label" for="price-all" >All Price</label>
                            <span class="badge border font-weight-normal">1000</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input filter" id="price-1" data-filter_min = "0" data-filter_max = "100000">
                            <label class="custom-control-label" for="price-1" >0đ - 100K</label>
                            <span class="badge border font-weight-normal">150</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input filter" id="price-2" data-filter_min = "100000" data-filter_max = "300000">
                            <label class="custom-control-label" for="price-2" >100K - 300K</label>
                            <span class="badge border font-weight-normal">295</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input filter" id="price-3" data-filter_min = "300000" data-filter_max = "1000000">
                            <label class="custom-control-label" for="price-3" >300K - 1000K</label>
                            <span class="badge border font-weight-normal">246</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input filter" id="price-4" data-filter_min = "1000000" data-filter_max = "9999999999999">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset("storage/upload/".$item->productImgs['0']->img_name)}}" alt="">
                                <div class="product-action">
                                    {{-- <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a> --}}
                                    <a class="btn btn-outline-dark btn-square" href="{{ route('product-detail',['id' =>$item->id]) }}"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
