                                    ...
                                    <div class="col-sm-8">
                                        <div class="card-block">
                                            ...
                                            <div class="row" style="padding-top: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="m-b-10 f-w-600">Thành phố:</p>
                                            ...
                                            <div class="row" style="padding-top: 10px">
                                                <div class="col-sm-6">
                                                    <p class="m-b-10 f-w-600">Phường, xã:</p>
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="m-b-10 f-w-600">Địa chỉ cụ thể</p>
                                                    <input class="form-control" type="text" value="{{ $user->address }}"
                                                        name="specific">
                                                </div>
                                            </div>
                                            <button class="btn btn-info" style="margin-top: 20px; border-radius: 8px" type="submit">Lưu</button>
